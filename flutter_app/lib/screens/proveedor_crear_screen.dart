...
class ProveedorCrearScreen extends StatefulWidget {
  const ProveedorCrearScreen({super.key, required this.servicio});
  final ProveedoresService servicio;

  @override
  State<ProveedorCrearScreen> createState() => _ProveedorCrearScreenState();
}

class _ProveedorCrearScreenState extends State<ProveedorCrearScreen> {
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _error = 'No se pudo crear el proveedor';
        _guardando = false;
      });
    }
  }
