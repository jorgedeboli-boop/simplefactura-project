...
CREATE TABLE empresa_configuracion (
    ...
    logotipo_file           VARCHAR(128) NULL COMMENT 'Nombre de archivo del logo subido por el tenant',
    color_primario          CHAR(7) NOT NULL DEFAULT '#398bf7',
    factura_design          TINYINT NOT NULL DEFAULT 1 COMMENT 'Numero de plantilla de factura (1-3)',
    color_design            VARCHAR(64) NOT NULL DEFAULT '#398bf7' COMMENT 'Color principal de la factura',
